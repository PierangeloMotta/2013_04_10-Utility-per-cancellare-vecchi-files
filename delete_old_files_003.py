...
#print (Anno_Mese)
try:
    f_log = open ("D:\\BesideUtility\\" + Anno_Mese + "_delete_old_files.log",'a')
    #print (f_log.name)
except IOError:
...
try:
    f_ini = open("D:\\BesideUtility\\delete_old_files.ini",'r')
except IOError:
    f_log.write (time.asctime(time.localtime()))
    f_log.write (" 10 Errore nell'aprire il file ini D:\\BesideUtility\\delete_old_files.ini\n")
    sys.exit (2)
...
try:
    ...
    IOError
    f_log.write (time.asctime(time.localtime()))
    f_log.write (" 20 Errore nell'aprire il file ini D:\\BesideUtility\\delete_old_files.ini\n")
    sys.exit(2)
